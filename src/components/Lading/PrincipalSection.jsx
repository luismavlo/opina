  ...
  return (
    <div className="principal-section">
      <article className="article-principal-section">
        <h2 className="title-principal-section">
          La investigación de mercados
        </h2>
        <h3 className="subtitle-principal-section">El amigo de las marcas</h3>
        <p className="description-principal-section">
          Porque transformamos las opiniones en estrategias que maximizan las
          oportunidades de crecimiento, alcanzando tus indicadores de venta,
          consolidando tu organización y estableciendo estrategias focalizadas
          en el plan marketing; de esta manera se logra cumplir estándares de
          calidad, rapidez y confianza.
        </p>
        <a
          className="btn-principal-section"
          href="/services/Investigacion de mercados.pdf"
          target="_blank"
        >
          Saber más
        </a>
      ...
      <div className="container-logo-principal-section">
        <img
          className="logo-principal-section"
          src={logoRed}
          alt="Logo red Background"
        />
      </div>
      <div className="container-img-principal-section">
        <img
          className="img-principal-section"
          src={mujerImg}
          alt="mujer voceando"
        />
      </div>
